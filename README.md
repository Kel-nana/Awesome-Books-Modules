...
Awesome books Project is a project meant to master my skills in version control, GitHub flow, pull requests in GitHub and JavaScript modules.
...
- [Live Demo Link](https://kel-nana.github.io/Awesome-Books-Modules/)
...
- git clone git@github.com:Kel-nana/Awesome-Books-Modules.git
...
Feel free to check the [issues page](https://github.com/Kel-nana/Awesome-Books-Modules/issues).
...
I would like to thank my coding partner and the microverse documentation
